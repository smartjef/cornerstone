  ...
  return (
    <div className="w-full relative bg-slate-50 dark:bg-slate-950 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6">
              <h2 className="text-sm font-bold tracking-widest text-emerald-600 uppercase">About Our Foundation</h2>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div className="space-y-10">
              <div className="space-y-4">
                <h3 className="text-2xl font-bold text-emerald-400 uppercase tracking-widest flex items-center gap-3">
            ...
            <div className="bg-white/10 backdrop-blur-md p-10 rounded-2xl border border-white/10">
              <h3 className="text-2xl font-bold text-emerald-400 uppercase tracking-widest mb-8 flex items-center gap-3">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {missionPillars.map((pillar, idx) => (
              <div key={idx} className="bg-white dark:bg-slate-950 p-8 border border-slate-200 dark:border-slate-800 flex items-start gap-6 group">
                <div className="font-bold text-4xl text-emerald-100 dark:text-emerald-900/40 group-hover:text-emerald-500 transition-colors">0{idx + 1}</div>
                <div>
                  <h4 className="text-xl font-bold text-slate-900 dark:text-white mb-3 hover:text-emerald-600 transition-colors">{pillar.title}</h4>
      ...
      <section className="w-full py-24 bg-white dark:bg-slate-950">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 uppercase border-b-2 border-emerald-500 pb-4 inline-block tracking-widest">
            ...
            {boardOfTrustees.map((member) => (
              <Link key={member.slug} href={`/team/${member.slug}`} className="group flex flex-col items-center bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-4 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
                ...
                <div className="text-center w-full">
                  ...
                  <p className="text-sm text-emerald-600 font-bold uppercase tracking-wider">{member.position}</p>
                </div>
              </Link>
            ))}
          </div>
      ...
      <section className="w-full py-24 bg-slate-50 dark:bg-slate-900">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="mb-12 text-slate-600 dark:text-slate-400 max-w-3xl">Our management team consists of dedicated volunteers, highly qualified in their profession and passionate for the objectives of the Cornerstone Foundation.</p>
          <div className="grid md:grid-cols-4 gap-8">
