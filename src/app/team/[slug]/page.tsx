    ...
    return (
        <div className="w-full bg-white dark:bg-slate-950 min-h-screen pt-32 pb-24">
            <div className="max-w-3xl mx-auto px-6">
                ...
                <Link
                    href="/about"
                    className="inline-flex items-center gap-2 text-sm text-slate-500 hover:text-emerald-600 transition-colors mb-10 font-medium"
                >
                ...
                <div className="flex flex-col sm:flex-row gap-10 items-start">
                    ...
                    <div className="space-y-4">
                        <span className="inline-block text-xs font-bold text-emerald-600 uppercase tracking-wider bg-emerald-50 dark:bg-emerald-900/40 px-3 py-1 rounded-full">
                        ...
                        <p className="text-lg font-semibold text-emerald-600">{member.position}</p>
