        ...
        <div className="grid lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-3 bg-white dark:bg-slate-900 p-8 md:p-12 border border-slate-200 dark:border-slate-800">
            ...
            <form className="space-y-8" onSubmit={(e) => e.preventDefault()}>
              ...
              <Button size="lg" className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-white font-bold h-14 px-12 rounded-none uppercase tracking-[0.2em] text-xs transition-all flex items-center gap-3">
